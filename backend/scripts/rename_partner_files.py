...
def main():
    ...
    for file_name in sorted(json_files):
        ...
        try:
            ...
            new_json_path = os.path.join(PARTNER_DIR, f"{new_name}.json")
            new_txt_path = os.path.join(PARTNER_DIR, f"{new_name}.txt")
