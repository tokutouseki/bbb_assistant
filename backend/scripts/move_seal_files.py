...
# -*- coding: utf-8 -*-
"""
脚本功能：根据分类结果移动往世乐土通用刻印目录中的文件到相应的目录
使用方法：直接运行此脚本
"""
...
CLASSIFICATION_FILE = r"d:\TokusCode\bbb_assistant\backend\data\往世乐土通用刻印文件分类结果.txt"
...
def main():
    ...
    for category_path, files in categories.items():
        ...
        for file_name in files:
            try:
                src_json = os.path.join(SEAL_DIR, file_name)
