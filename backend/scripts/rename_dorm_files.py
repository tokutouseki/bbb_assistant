...
# -*- coding: utf-8 -*-
"""
脚本功能：重命名宿舍名册目录中的文件，根据title提取名称
使用方法：直接运行此脚本
"""
...
def main():
    ...
    for file_name in sorted(json_files):
        ...
        try:
            ...
            new_json_path = os.path.join(DORM_DIR, f"{new_name}.json")
            new_txt_path = os.path.join(DORM_DIR, f"{new_name}.txt")
