...
# -*- coding: utf-8 -*-
"""
脚本功能：使用playwright访问URL并获取面包屑导航信息，按照分类整理女武神文件
使用方法：直接运行此脚本
...
# 结果保存文件路径
OUTPUT_FILE = r"d:\TokusCode\bbb_assistant\backend\data\女武神文件分类结果.txt"
        ...
        for file_name in sorted(os.listdir(VALKYRIE_DIR)):
            if file_name.endswith('.json'):
                ...
                try:
                    ...
                    if url:
                        print(f"[{file_count}/665] 处理: {file_name}")
