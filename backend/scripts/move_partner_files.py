...
CLASSIFICATION_FILE = r"d:\TokusCode\bbb_assistant\backend\data\协同者文件分类结果.txt"
...
def main():
    ...
    for category_path, files in categories.items():
        ...
        for file_name in files:
            try:
                src_json = os.path.join(PARTNER_DIR, file_name)
