...
# -*- coding: utf-8 -*-
"""
脚本功能：收集往世乐土通用刻印目录中所有JSON文件的URL，并通过面包屑导航进行分类
使用方法：直接运行此脚本
"""
...
URL_FILE = r"d:\TokusCode\bbb_assistant\backend\data\往世乐土通用刻印文件URL列表.txt"
OUTPUT_FILE = r"d:\TokusCode\bbb_assistant\backend\data\往世乐土通用刻印文件分类结果.txt"
...
async def main():
    print("开始收集往世乐土通用刻印目录中的URL并进行分类...")
    print("=" * 80)
